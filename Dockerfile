...
RUN pacman -Syy --noconfirm core/diffutils core/dosfstools core/patch extra/wget core/which extra/arch-install-scripts extra/imagemagick extra/librsvg extra/lsof extra/parted extra/qemu-img
